...
--
-- Host: localhost    Database: ead_joomla
-- ------------------------------------------------------
...
--
-- Table structure for table `bwjlw_action_log_config`
--

DROP TABLE IF EXISTS `bwjlw_action_log_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_action_log_config` (
...
--
-- Dumping data for table `bwjlw_action_log_config`
--

LOCK TABLES `bwjlw_action_log_config` WRITE;
/*!40000 ALTER TABLE `bwjlw_action_log_config` DISABLE KEYS */;
INSERT INTO `bwjlw_action_log_config` VALUES
...
/*!40000 ALTER TABLE `bwjlw_action_log_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_action_logs`
--

DROP TABLE IF EXISTS `bwjlw_action_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_action_logs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_action_logs`
--

LOCK TABLES `bwjlw_action_logs` WRITE;
/*!40000 ALTER TABLE `bwjlw_action_logs` DISABLE KEYS */;
INSERT INTO `bwjlw_action_logs` VALUES
(1,'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN','{\"action\":\"login\",\"userid\":783,\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=783\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}','2022-03-09 19:18:12','com_users',783,0,'COM_ACTIONLOGS_DISABLED');
/*!40000 ALTER TABLE `bwjlw_action_logs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_action_logs_extensions`
--

DROP TABLE IF EXISTS `bwjlw_action_logs_extensions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_action_logs_extensions`
--

LOCK TABLES `bwjlw_action_logs_extensions` WRITE;
/*!40000 ALTER TABLE `bwjlw_action_logs_extensions` DISABLE KEYS */;
INSERT INTO `bwjlw_action_logs_extensions` VALUES
(1,'com_banners'),
(2,'com_cache'),
(3,'com_categories'),
(4,'com_config'),
...
(18,'com_checkin'),
(19,'com_scheduler');
/*!40000 ALTER TABLE `bwjlw_action_logs_extensions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_action_logs_users`
--

DROP TABLE IF EXISTS `bwjlw_action_logs_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_action_logs_users` (
...
--
-- Dumping data for table `bwjlw_action_logs_users`
--

LOCK TABLES `bwjlw_action_logs_users` WRITE;
/*!40000 ALTER TABLE `bwjlw_action_logs_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_action_logs_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_assets`
--

DROP TABLE IF EXISTS `bwjlw_assets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_assets` (
...
--
-- Dumping data for table `bwjlw_assets`
--

LOCK TABLES `bwjlw_assets` WRITE;
/*!40000 ALTER TABLE `bwjlw_assets` DISABLE KEYS */;
INSERT INTO `bwjlw_assets` VALUES
...
/*!40000 ALTER TABLE `bwjlw_assets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_associations`
--

DROP TABLE IF EXISTS `bwjlw_associations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_associations` (
...
--
-- Dumping data for table `bwjlw_associations`
--

LOCK TABLES `bwjlw_associations` WRITE;
/*!40000 ALTER TABLE `bwjlw_associations` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_associations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_banner_clients`
--

DROP TABLE IF EXISTS `bwjlw_banner_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_banner_clients` (
...
--
-- Dumping data for table `bwjlw_banner_clients`
--

LOCK TABLES `bwjlw_banner_clients` WRITE;
/*!40000 ALTER TABLE `bwjlw_banner_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_banner_clients` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_banner_tracks`
--

DROP TABLE IF EXISTS `bwjlw_banner_tracks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_banner_tracks` (
...
--
-- Dumping data for table `bwjlw_banner_tracks`
--

LOCK TABLES `bwjlw_banner_tracks` WRITE;
/*!40000 ALTER TABLE `bwjlw_banner_tracks` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_banner_tracks` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_banners`
--

DROP TABLE IF EXISTS `bwjlw_banners`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_banners`
--

LOCK TABLES `bwjlw_banners` WRITE;
/*!40000 ALTER TABLE `bwjlw_banners` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_banners` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_categories`
--

DROP TABLE IF EXISTS `bwjlw_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_categories`
--

LOCK TABLES `bwjlw_categories` WRITE;
/*!40000 ALTER TABLE `bwjlw_categories` DISABLE KEYS */;
INSERT INTO `bwjlw_categories` VALUES
(1,0,0,0,11,0,'','system','ROOT','root','','',1,NULL,NULL,1,'{}','','','{}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1),
(2,27,1,1,2,1,'uncategorised','com_content','Uncategorised','uncategorised','','',1,NULL,NULL,1,'{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}','','','{\"author\":\"\",\"robots\":\"\"}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1),
(3,28,1,3,4,1,'uncategorised','com_banners','Uncategorised','uncategorised','','',1,NULL,NULL,1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1),
(4,29,1,5,6,1,'uncategorised','com_contact','Uncategorised','uncategorised','','',1,NULL,NULL,1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1),
(5,30,1,7,8,1,'uncategorised','com_newsfeeds','Uncategorised','uncategorised','','',1,NULL,NULL,1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1),
(7,32,1,9,10,1,'uncategorised','com_users','Uncategorised','uncategorised','','',1,NULL,NULL,1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',783,'2022-03-09 19:13:29',783,'2022-03-09 19:13:29',0,'*',1);
/*!40000 ALTER TABLE `bwjlw_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_contact_details`
--

DROP TABLE IF EXISTS `bwjlw_contact_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_contact_details`
--

LOCK TABLES `bwjlw_contact_details` WRITE;
/*!40000 ALTER TABLE `bwjlw_contact_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_contact_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_content`
--

DROP TABLE IF EXISTS `bwjlw_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bwjlw_content`
--

LOCK TABLES `bwjlw_content` WRITE;
/*!40000 ALTER TABLE `bwjlw_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_content_frontpage`
--

DROP TABLE IF EXISTS `bwjlw_content_frontpage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_content_frontpage` (
...
--
-- Dumping data for table `bwjlw_content_frontpage`
--

LOCK TABLES `bwjlw_content_frontpage` WRITE;
/*!40000 ALTER TABLE `bwjlw_content_frontpage` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_content_frontpage` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_content_rating`
--

DROP TABLE IF EXISTS `bwjlw_content_rating`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_content_rating`
--

LOCK TABLES `bwjlw_content_rating` WRITE;
/*!40000 ALTER TABLE `bwjlw_content_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_content_rating` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_content_types`
--

DROP TABLE IF EXISTS `bwjlw_content_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_content_types` (
...
--
-- Dumping data for table `bwjlw_content_types`
--

LOCK TABLES `bwjlw_content_types` WRITE;
/*!40000 ALTER TABLE `bwjlw_content_types` DISABLE KEYS */;
INSERT INTO `bwjlw_content_types` VALUES
...
/*!40000 ALTER TABLE `bwjlw_content_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_contentitem_tag_map`
--

DROP TABLE IF EXISTS `bwjlw_contentitem_tag_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bwjlw_contentitem_tag_map`
--

LOCK TABLES `bwjlw_contentitem_tag_map` WRITE;
/*!40000 ALTER TABLE `bwjlw_contentitem_tag_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_contentitem_tag_map` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_extensions`
--

DROP TABLE IF EXISTS `bwjlw_extensions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_extensions` (
...
--
-- Dumping data for table `bwjlw_extensions`
--

LOCK TABLES `bwjlw_extensions` WRITE;
/*!40000 ALTER TABLE `bwjlw_extensions` DISABLE KEYS */;
INSERT INTO `bwjlw_extensions` VALUES
...
(10,0,'com_languages','component','com_languages',NULL,'',1,1,1,1,1,'{\"name\":\"com_languages\",\"type\":\"component\",\"creationDate\":\"April 2006\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.0.0\",\"description\":\"COM_LANGUAGES_XML_DESCRIPTION\",\"group\":\"\"}','{\"administrator\":\"fr-FR\",\"site\":\"fr-FR\"}','',NULL,NULL,0,0,NULL),
...
(36,0,'lib_joomla','library','joomla',NULL,'',0,1,1,1,1,'{\"name\":\"lib_joomla\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2008 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}','{\"mediaversion\":\"a823ee2e7be359d75d6c86f526d4bd9c\"}','',NULL,NULL,0,0,NULL),
...
(185,0,'plg_system_updatenotification','plugin','updatenotification',NULL,'system',0,1,1,0,1,'{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}','{\"lastrun\":1646853480}','',NULL,NULL,23,0,NULL),
...
(222,0,'French (fr-FR) Language pack','package','pkg_fr-FR',NULL,'',0,1,1,0,0,'{\"name\":\"French (fr-FR) Language pack\",\"type\":\"package\",\"creationDate\":\"F\\u00e9vrier 2022\",\"author\":\"Joomla! Project - French translation team\",\"copyright\":\"Copyright (C) 2021 Open Source Matters, Inc.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"www.joomla.fr\",\"version\":\"4.1.0.2\",\"description\":\"<div style=\\\"text-align: left;\\\">\\n<h3>Joomla! 4 Full French (fr-FR) Language Package - Version 4.1.0 v2<\\/h3>\\n<h3>Pack de langue Joomla! 4 fran\\u00e7ais (fr-FR) complet - Version 4.1.0 v2<\\/h3>\\n<p><a href=\\\"https:\\/www.joomla.fr\\\" target=\\\"_blank\\\">www.joomla.fr<\\/a> - <a href=\\\"mailto:traduction@joomla.fr\\\">traduction@joomla.fr<\\/a><\\/p>\\n<\\/div>\",\"group\":\"\",\"filename\":\"pkg_fr-FR\"}','','',NULL,NULL,0,0,NULL),
(223,221,'English (en-GB)','language','en-GB',NULL,'',0,1,1,1,1,'{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"February 2022\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.1.0\",\"description\":\"en-GB site language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL),
(224,221,'English (en-GB)','language','en-GB',NULL,'',1,1,1,1,1,'{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"February 2022\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2005 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.1.0\",\"description\":\"en-GB administrator language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL),
(225,221,'English (en-GB)','language','en-GB',NULL,'',3,1,1,1,1,'{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"February 2022\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2020 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.1.0\",\"description\":\"en-GB api language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL),
(226,222,'French (fr-FR)','language','fr-FR',NULL,'',0,1,0,0,0,'{\"name\":\"French (fr-FR)\",\"type\":\"language\",\"creationDate\":\"F\\u00e9vrier 2022\",\"author\":\"Joomla! Project - French translation team\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"www.joomla.fr\",\"version\":\"4.1.0\",\"description\":\"fr-FR site language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL),
(227,222,'French (fr-FR)','language','fr-FR',NULL,'',1,1,0,0,0,'{\"name\":\"French (fr-FR)\",\"type\":\"language\",\"creationDate\":\"F\\u00e9vrier 2022\",\"author\":\"Joomla! Project - French translation team\",\"copyright\":\"(C) 2005 Open Source Matters, Inc.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"www.joomla.fr\",\"version\":\"4.1.0\",\"description\":\"fr-FR Administrator language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL),
(228,222,'French (fr-FR)','language','fr-FR',NULL,'',3,1,0,0,0,'{\"name\":\"French (fr-FR)\",\"type\":\"language\",\"creationDate\":\"F\\u00e9vrier 2022\",\"author\":\"Joomla! Project - French translation team\",\"copyright\":\"(C) 2020 Open Source Matters, Inc.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"www.joomla.fr\",\"version\":\"4.1.0\",\"description\":\"fr-FR api language\",\"group\":\"\"}','','',NULL,NULL,0,0,NULL);
/*!40000 ALTER TABLE `bwjlw_extensions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_fields`
--

DROP TABLE IF EXISTS `bwjlw_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_fields`
--

LOCK TABLES `bwjlw_fields` WRITE;
/*!40000 ALTER TABLE `bwjlw_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_fields` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_fields_categories`
--

DROP TABLE IF EXISTS `bwjlw_fields_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_fields_categories` (
...
--
-- Dumping data for table `bwjlw_fields_categories`
--

LOCK TABLES `bwjlw_fields_categories` WRITE;
/*!40000 ALTER TABLE `bwjlw_fields_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_fields_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_fields_groups`
--

DROP TABLE IF EXISTS `bwjlw_fields_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_fields_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bwjlw_fields_groups`
--

LOCK TABLES `bwjlw_fields_groups` WRITE;
/*!40000 ALTER TABLE `bwjlw_fields_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_fields_groups` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_fields_values`
--

DROP TABLE IF EXISTS `bwjlw_fields_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_fields_values` (
...
--
-- Dumping data for table `bwjlw_fields_values`
--

LOCK TABLES `bwjlw_fields_values` WRITE;
/*!40000 ALTER TABLE `bwjlw_fields_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_fields_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_filters`
--

DROP TABLE IF EXISTS `bwjlw_finder_filters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_filters` (
...
--
-- Dumping data for table `bwjlw_finder_filters`
--

LOCK TABLES `bwjlw_finder_filters` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_filters` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_filters` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_links`
--

DROP TABLE IF EXISTS `bwjlw_finder_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_links` (
...
--
-- Dumping data for table `bwjlw_finder_links`
--

LOCK TABLES `bwjlw_finder_links` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_links` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_links_terms`
--

DROP TABLE IF EXISTS `bwjlw_finder_links_terms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_links_terms` (
...
--
-- Dumping data for table `bwjlw_finder_links_terms`
--

LOCK TABLES `bwjlw_finder_links_terms` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_links_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_links_terms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_logging`
--

DROP TABLE IF EXISTS `bwjlw_finder_logging`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_logging` (
...
--
-- Dumping data for table `bwjlw_finder_logging`
--

LOCK TABLES `bwjlw_finder_logging` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_logging` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_logging` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_taxonomy`
--

DROP TABLE IF EXISTS `bwjlw_finder_taxonomy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_finder_taxonomy`
--

LOCK TABLES `bwjlw_finder_taxonomy` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_taxonomy` DISABLE KEYS */;
INSERT INTO `bwjlw_finder_taxonomy` VALUES
(1,0,0,1,0,'','ROOT','root',1,1,'*');
/*!40000 ALTER TABLE `bwjlw_finder_taxonomy` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `bwjlw_finder_taxonomy_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `bwjlw_finder_taxonomy_map`
--

LOCK TABLES `bwjlw_finder_taxonomy_map` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_taxonomy_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_taxonomy_map` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_terms`
--

DROP TABLE IF EXISTS `bwjlw_finder_terms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_terms` (
...
--
-- Dumping data for table `bwjlw_finder_terms`
--

LOCK TABLES `bwjlw_finder_terms` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_terms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_terms_common`
--

DROP TABLE IF EXISTS `bwjlw_finder_terms_common`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_terms_common` (
...
--
-- Dumping data for table `bwjlw_finder_terms_common`
--

LOCK TABLES `bwjlw_finder_terms_common` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_terms_common` DISABLE KEYS */;
INSERT INTO `bwjlw_finder_terms_common` VALUES
('a','en',0),
('about','en',0),
('above','en',0),
('after','en',0),
...
('yourself','en',0),
('yourselves','en',0);
/*!40000 ALTER TABLE `bwjlw_finder_terms_common` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_tokens`
--

DROP TABLE IF EXISTS `bwjlw_finder_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) unsigned NOT NULL DEFAULT 0,
  `phrase` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_finder_tokens`
--

LOCK TABLES `bwjlw_finder_tokens` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_tokens` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `bwjlw_finder_tokens_aggregate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_finder_tokens_aggregate`
--

LOCK TABLES `bwjlw_finder_tokens_aggregate` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_tokens_aggregate` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_tokens_aggregate` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_finder_types`
--

DROP TABLE IF EXISTS `bwjlw_finder_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_finder_types`
--

LOCK TABLES `bwjlw_finder_types` WRITE;
/*!40000 ALTER TABLE `bwjlw_finder_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_finder_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_history`
--

DROP TABLE IF EXISTS `bwjlw_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_history` (
...
--
-- Dumping data for table `bwjlw_history`
--

LOCK TABLES `bwjlw_history` WRITE;
/*!40000 ALTER TABLE `bwjlw_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_languages`
--

DROP TABLE IF EXISTS `bwjlw_languages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_languages` (
...
--
-- Dumping data for table `bwjlw_languages`
--

LOCK TABLES `bwjlw_languages` WRITE;
/*!40000 ALTER TABLE `bwjlw_languages` DISABLE KEYS */;
INSERT INTO `bwjlw_languages` VALUES
(1,0,'en-GB','English (en-GB)','English (United Kingdom)','en','en_gb','','','','',1,1,2),
(2,0,'fr-FR','French (fr-FR)','Fran├ºais (France)','fr','fr_fr','','','','',1,1,1);
/*!40000 ALTER TABLE `bwjlw_languages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_mail_templates`
--

DROP TABLE IF EXISTS `bwjlw_mail_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_mail_templates` (
...
--
-- Dumping data for table `bwjlw_mail_templates`
--

LOCK TABLES `bwjlw_mail_templates` WRITE;
/*!40000 ALTER TABLE `bwjlw_mail_templates` DISABLE KEYS */;
INSERT INTO `bwjlw_mail_templates` VALUES
...
/*!40000 ALTER TABLE `bwjlw_mail_templates` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_menu`
--

DROP TABLE IF EXISTS `bwjlw_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_menu`
--

LOCK TABLES `bwjlw_menu` WRITE;
/*!40000 ALTER TABLE `bwjlw_menu` DISABLE KEYS */;
INSERT INTO `bwjlw_menu` VALUES
...
--
-- Dumping data for table `bwjlw_menu_types`
--

LOCK TABLES `bwjlw_menu_types` WRITE;
/*!40000 ALTER TABLE `bwjlw_menu_types` DISABLE KEYS */;
INSERT INTO `bwjlw_menu_types` VALUES
(1,0,'mainmenu','Menu principal','Le menu principal du site',0);
/*!40000 ALTER TABLE `bwjlw_menu_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_messages`
--

DROP TABLE IF EXISTS `bwjlw_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_messages` (
...
--
-- Dumping data for table `bwjlw_messages`
--

LOCK TABLES `bwjlw_messages` WRITE;
/*!40000 ALTER TABLE `bwjlw_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_messages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_messages_cfg`
--

DROP TABLE IF EXISTS `bwjlw_messages_cfg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_messages_cfg` (
...
--
-- Dumping data for table `bwjlw_messages_cfg`
--

LOCK TABLES `bwjlw_messages_cfg` WRITE;
/*!40000 ALTER TABLE `bwjlw_messages_cfg` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_messages_cfg` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_modules`
--

DROP TABLE IF EXISTS `bwjlw_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `bwjlw_modules`
--

LOCK TABLES `bwjlw_modules` WRITE;
/*!40000 ALTER TABLE `bwjlw_modules` DISABLE KEYS */;
INSERT INTO `bwjlw_modules` VALUES
...
(10,45,'Utilisateurs connect├®s','','',2,'cpanel',NULL,NULL,NULL,NULL,1,'mod_logged',3,1,'{\"count\":\"5\",\"name\":\"1\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":\"0\", \"bootstrap_size\": \"12\",\"header_tag\":\"h2\"}',1,'*'),
...
(17,51,'Fil de navigation','','',1,'breadcrumbs',NULL,NULL,NULL,NULL,1,'mod_breadcrumbs',1,1,'{\"moduleclass_sfx\":\"\",\"showHome\":\"1\",\"homeText\":\"\",\"showComponent\":\"1\",\"separator\":\"\",\"cache\":\"0\",\"cache_time\":\"0\",\"cachemode\":\"itemid\"}',0,'*'),
...
(87,55,'Donn├®es exemple','','',0,'cpanel',NULL,NULL,NULL,NULL,1,'mod_sampledata',6,1,'{\"bootstrap_size\": \"12\",\"header_tag\":\"h2\"}',1,'*'),
(88,67,'Derni├¿res actions','','',0,'cpanel',NULL,NULL,NULL,NULL,1,'mod_latestactions',6,1,'{\"bootstrap_size\": \"12\",\"header_tag\":\"h2\"}',1,'*'),
(89,68,'Demande de confidentialit├®','','',0,'cpanel',NULL,NULL,NULL,NULL,1,'mod_privacy_dashboard',6,1,'{\"bootstrap_size\": \"12\",\"header_tag\":\"h2\"}',1,'*'),
(90,65,'Aide ├á la connexion','','',1,'sidebar',NULL,NULL,NULL,NULL,1,'mod_loginsupport',1,1,'{\"forum_url\":\"https://forum.joomla.org/\",\"documentation_url\":\"https://docs.joomla.org/\",\"news_url\":\"https://www.joomla.org/announcements.html\",\"automatic_title\":1,\"prepare_content\":1,\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":1,\"cache_time\":900,\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}',1,'*'),
(91,72,'Syst├¿me','','',1,'cpanel-system',NULL,NULL,NULL,NULL,1,'mod_submenu',1,0,'{\"menutype\":\"*\",\"preset\":\"system\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"module_tag\":\"div\",\"bootstrap_size\":\"12\",\"header_tag\":\"h2\",\"header_class\":\"\",\"style\":\"System-none\"}',1,'*'),
...
(98,88,'Utilisateurs identifi├®s','','',2,'cpanel-users',NULL,NULL,NULL,NULL,1,'mod_logged',3,1,'{\"count\":\"5\",\"name\":\"1\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":\"0\", \"bootstrap_size\": \"12\",\"header_tag\":\"h2\"}',1,'*'),
...
(104,71,'Syst├¿me','','',2,'icon',NULL,NULL,NULL,NULL,1,'mod_quickicon',1,1,'{\"context\":\"system_quickicon\",\"header_icon\":\"icon-wrench\",\"show_global\":\"1\",\"show_checkin\":\"1\",\"show_cache\":\"1\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":1,\"cache_time\":900,\"style\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"12\",\"header_tag\":\"h2\",\"header_class\":\"\"}',1,'*'),
...
(107,84,'Demande de confidentialit├®','','',1,'cpanel-privacy',NULL,NULL,NULL,NULL,1,'mod_privacy_dashboard',1,1,'{\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":1,\"cache_time\":900,\"cachemode\":\"static\",\"style\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"12\",\"header_tag\":\"h2\",\"header_class\":\"\"}',1,'*'),
(108,85,'Statut de confidentialit├®','','',1,'cpanel-privacy',NULL,NULL,NULL,NULL,1,'mod_privacy_status',1,1,'{\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":1,\"cache_time\":900,\"cachemode\":\"static\",\"style\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"12\",\"header_tag\":\"h2\",\"header_class\":\"\"}',1,'*');
/*!40000 ALTER TABLE `bwjlw_modules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_modules_menu`
--

DROP TABLE IF EXISTS `bwjlw_modules_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_modules_menu` (
...
--
-- Dumping data for table `bwjlw_modules_menu`
--

LOCK TABLES `bwjlw_modules_menu` WRITE;
/*!40000 ALTER TABLE `bwjlw_modules_menu` DISABLE KEYS */;
INSERT INTO `bwjlw_modules_menu` VALUES
(1,0),
(2,0),
(3,0),
(4,0),
...
(107,0),
(108,0);
/*!40000 ALTER TABLE `bwjlw_modules_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_newsfeeds`
--

DROP TABLE IF EXISTS `bwjlw_newsfeeds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_newsfeeds`
--

LOCK TABLES `bwjlw_newsfeeds` WRITE;
/*!40000 ALTER TABLE `bwjlw_newsfeeds` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_newsfeeds` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_overrider`
--

DROP TABLE IF EXISTS `bwjlw_overrider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_overrider` (
...
--
-- Dumping data for table `bwjlw_overrider`
--

LOCK TABLES `bwjlw_overrider` WRITE;
/*!40000 ALTER TABLE `bwjlw_overrider` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_overrider` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_postinstall_messages`
--

DROP TABLE IF EXISTS `bwjlw_postinstall_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_postinstall_messages` (
...
--
-- Dumping data for table `bwjlw_postinstall_messages`
--

LOCK TABLES `bwjlw_postinstall_messages` WRITE;
/*!40000 ALTER TABLE `bwjlw_postinstall_messages` DISABLE KEYS */;
INSERT INTO `bwjlw_postinstall_messages` VALUES
...
/*!40000 ALTER TABLE `bwjlw_postinstall_messages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_privacy_consents`
--

DROP TABLE IF EXISTS `bwjlw_privacy_consents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_privacy_consents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Dumping data for table `bwjlw_privacy_consents`
--

LOCK TABLES `bwjlw_privacy_consents` WRITE;
/*!40000 ALTER TABLE `bwjlw_privacy_consents` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_privacy_consents` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_privacy_requests`
--

DROP TABLE IF EXISTS `bwjlw_privacy_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_privacy_requests` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_privacy_requests`
--

LOCK TABLES `bwjlw_privacy_requests` WRITE;
/*!40000 ALTER TABLE `bwjlw_privacy_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_privacy_requests` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_redirect_links`
--

DROP TABLE IF EXISTS `bwjlw_redirect_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_redirect_links`
--

LOCK TABLES `bwjlw_redirect_links` WRITE;
/*!40000 ALTER TABLE `bwjlw_redirect_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_redirect_links` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_scheduler_tasks`
--

DROP TABLE IF EXISTS `bwjlw_scheduler_tasks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_scheduler_tasks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bwjlw_scheduler_tasks`
--

LOCK TABLES `bwjlw_scheduler_tasks` WRITE;
/*!40000 ALTER TABLE `bwjlw_scheduler_tasks` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_scheduler_tasks` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_schemas`
--

DROP TABLE IF EXISTS `bwjlw_schemas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_schemas` (
...
--
-- Dumping data for table `bwjlw_schemas`
--

LOCK TABLES `bwjlw_schemas` WRITE;
/*!40000 ALTER TABLE `bwjlw_schemas` DISABLE KEYS */;
INSERT INTO `bwjlw_schemas` VALUES
(220,'4.1.0-2022-01-24');
/*!40000 ALTER TABLE `bwjlw_schemas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_session`
--

DROP TABLE IF EXISTS `bwjlw_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_session` (
...
--
-- Dumping data for table `bwjlw_session`
--

LOCK TABLES `bwjlw_session` WRITE;
/*!40000 ALTER TABLE `bwjlw_session` DISABLE KEYS */;
INSERT INTO `bwjlw_session` VALUES
('a98247bc9415022c2568d1380351c68e',1,0,1646853891,'joomla|s:884:\"\";',783,'root');
/*!40000 ALTER TABLE `bwjlw_session` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_tags`
--

DROP TABLE IF EXISTS `bwjlw_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_tags`
--

LOCK TABLES `bwjlw_tags` WRITE;
/*!40000 ALTER TABLE `bwjlw_tags` DISABLE KEYS */;
INSERT INTO `bwjlw_tags` VALUES
(1,0,0,1,0,'','ROOT','root','','',1,NULL,NULL,1,'','','','',783,'2022-03-09 19:13:27','',783,'2022-03-09 19:13:27','','',0,'*',1,NULL,NULL);
/*!40000 ALTER TABLE `bwjlw_tags` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_template_overrides`
--

DROP TABLE IF EXISTS `bwjlw_template_overrides`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_template_overrides` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_template_overrides`
--

LOCK TABLES `bwjlw_template_overrides` WRITE;
/*!40000 ALTER TABLE `bwjlw_template_overrides` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_template_overrides` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_template_styles`
--

DROP TABLE IF EXISTS `bwjlw_template_styles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_template_styles`
--

LOCK TABLES `bwjlw_template_styles` WRITE;
/*!40000 ALTER TABLE `bwjlw_template_styles` DISABLE KEYS */;
INSERT INTO `bwjlw_template_styles` VALUES
...
/*!40000 ALTER TABLE `bwjlw_template_styles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_ucm_base`
--

DROP TABLE IF EXISTS `bwjlw_ucm_base`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_ucm_base` (
...
--
-- Dumping data for table `bwjlw_ucm_base`
--

LOCK TABLES `bwjlw_ucm_base` WRITE;
/*!40000 ALTER TABLE `bwjlw_ucm_base` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_ucm_base` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_ucm_content`
--

DROP TABLE IF EXISTS `bwjlw_ucm_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_ucm_content` (
...
--
-- Dumping data for table `bwjlw_ucm_content`
--

LOCK TABLES `bwjlw_ucm_content` WRITE;
/*!40000 ALTER TABLE `bwjlw_ucm_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_ucm_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_update_sites`
--

DROP TABLE IF EXISTS `bwjlw_update_sites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_update_sites` (
...
--
-- Dumping data for table `bwjlw_update_sites`
--

LOCK TABLES `bwjlw_update_sites` WRITE;
/*!40000 ALTER TABLE `bwjlw_update_sites` DISABLE KEYS */;
INSERT INTO `bwjlw_update_sites` VALUES
(1,'Joomla! Core','collection','https://update.joomla.org/core/list.xml',1,1646853481,'',NULL,NULL),
(2,'Accredited Joomla! Translations','collection','https://update.joomla.org/language/translationlist_4.xml',1,1646853220,'',NULL,NULL),
(3,'Joomla! Update Component Update Site','extension','https://update.joomla.org/core/extensions/com_joomlaupdate.xml',1,1646853821,'',NULL,NULL);
/*!40000 ALTER TABLE `bwjlw_update_sites` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_update_sites_extensions`
--

DROP TABLE IF EXISTS `bwjlw_update_sites_extensions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_update_sites_extensions` (
...
--
-- Dumping data for table `bwjlw_update_sites_extensions`
--

LOCK TABLES `bwjlw_update_sites_extensions` WRITE;
/*!40000 ALTER TABLE `bwjlw_update_sites_extensions` DISABLE KEYS */;
INSERT INTO `bwjlw_update_sites_extensions` VALUES
(1,220),
(2,221),
(3,24);
/*!40000 ALTER TABLE `bwjlw_update_sites_extensions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_updates`
--

DROP TABLE IF EXISTS `bwjlw_updates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_updates` (
...
--
-- Dumping data for table `bwjlw_updates`
--

LOCK TABLES `bwjlw_updates` WRITE;
/*!40000 ALTER TABLE `bwjlw_updates` DISABLE KEYS */;
INSERT INTO `bwjlw_updates` VALUES
...
(5,2,0,'Czech','','pkg_cs-CZ','package','',0,'4.0.6.1','','https://update.joomla.org/language/details4/cs-CZ_details.xml','','',''),
...
(15,2,0,'Georgian','','pkg_ka-GE','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/ka-GE_details.xml','','',''),
(16,2,0,'German','','pkg_de-DE','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/de-DE_details.xml','','',''),
(17,2,0,'German, Austria','','pkg_de-AT','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/de-AT_details.xml','','',''),
(18,2,0,'German, Liechtenstein','','pkg_de-LI','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/de-LI_details.xml','','',''),
(19,2,0,'German, Luxembourg','','pkg_de-LU','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/de-LU_details.xml','','',''),
(20,2,0,'German, Switzerland','','pkg_de-CH','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/de-CH_details.xml','','',''),
(21,2,0,'Greek','','pkg_el-GR','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/el-GR_details.xml','','',''),
(22,2,0,'Hungarian','','pkg_hu-HU','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/hu-HU_details.xml','','',''),
(23,2,0,'Italian','','pkg_it-IT','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/it-IT_details.xml','','',''),
(24,2,0,'Japanese','','pkg_ja-JP','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/ja-JP_details.xml','','',''),
(25,2,0,'Norwegian Bokm├Ñl','','pkg_nb-NO','package','',0,'4.0.1.1','','https://update.joomla.org/language/details4/nb-NO_details.xml','','',''),
(26,2,0,'Persian Farsi','','pkg_fa-IR','package','',0,'4.0.6.1','','https://update.joomla.org/language/details4/fa-IR_details.xml','','',''),
(27,2,0,'Polish','','pkg_pl-PL','package','',0,'4.1.0.3','','https://update.joomla.org/language/details4/pl-PL_details.xml','','',''),
...
(30,2,0,'Romanian','','pkg_ro-RO','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/ro-RO_details.xml','','',''),
(31,2,0,'Russian','','pkg_ru-RU','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/ru-RU_details.xml','','',''),
(32,2,0,'Slovak','','pkg_sk-SK','package','',0,'4.0.6.1','','https://update.joomla.org/language/details4/sk-SK_details.xml','','',''),
(33,2,0,'Slovenian','','pkg_sl-SI','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/sl-SI_details.xml','','',''),
(34,2,0,'Spanish','','pkg_es-ES','package','',0,'4.0.5.1','','https://update.joomla.org/language/details4/es-ES_details.xml','','',''),
(35,2,0,'Swedish','','pkg_sv-SE','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/sv-SE_details.xml','','',''),
(36,2,0,'Tamil, India','','pkg_ta-IN','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/ta-IN_details.xml','','',''),
(37,2,0,'Thai','','pkg_th-TH','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/th-TH_details.xml','','',''),
(38,2,0,'Turkish','','pkg_tr-TR','package','',0,'4.1.0.1','','https://update.joomla.org/language/details4/tr-TR_details.xml','','',''),
(39,2,0,'Ukrainian','','pkg_uk-UA','package','',0,'4.0.3.2','','https://update.joomla.org/language/details4/uk-UA_details.xml','','',''),
(40,2,0,'Welsh','','pkg_cy-GB','package','',0,'4.1.0.2','','https://update.joomla.org/language/details4/cy-GB_details.xml','','','');
/*!40000 ALTER TABLE `bwjlw_updates` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_user_keys`
--

DROP TABLE IF EXISTS `bwjlw_user_keys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_user_keys`
--

LOCK TABLES `bwjlw_user_keys` WRITE;
/*!40000 ALTER TABLE `bwjlw_user_keys` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_user_keys` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_user_notes`
--

DROP TABLE IF EXISTS `bwjlw_user_notes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT 0,
  `catid` int(10) unsigned NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `bwjlw_user_notes`
--

LOCK TABLES `bwjlw_user_notes` WRITE;
/*!40000 ALTER TABLE `bwjlw_user_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_user_notes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_user_profiles`
--

DROP TABLE IF EXISTS `bwjlw_user_profiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_user_profiles` (
...
--
-- Dumping data for table `bwjlw_user_profiles`
--

LOCK TABLES `bwjlw_user_profiles` WRITE;
/*!40000 ALTER TABLE `bwjlw_user_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_user_profiles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_user_usergroup_map`
--

DROP TABLE IF EXISTS `bwjlw_user_usergroup_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_user_usergroup_map` (
...
--
-- Dumping data for table `bwjlw_user_usergroup_map`
--

LOCK TABLES `bwjlw_user_usergroup_map` WRITE;
/*!40000 ALTER TABLE `bwjlw_user_usergroup_map` DISABLE KEYS */;
INSERT INTO `bwjlw_user_usergroup_map` VALUES
(783,8);
/*!40000 ALTER TABLE `bwjlw_user_usergroup_map` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_usergroups`
--

DROP TABLE IF EXISTS `bwjlw_usergroups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `bwjlw_usergroups`
--

LOCK TABLES `bwjlw_usergroups` WRITE;
/*!40000 ALTER TABLE `bwjlw_usergroups` DISABLE KEYS */;
INSERT INTO `bwjlw_usergroups` VALUES
(1,0,1,18,'Public'),
(2,1,8,15,'Enregistr├®'),
(3,2,9,14,'Auteur'),
(4,3,10,13,'R├®dacteur'),
...
(9,1,2,3,'Invit├®');
/*!40000 ALTER TABLE `bwjlw_usergroups` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_users`
--

DROP TABLE IF EXISTS `bwjlw_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_users`
--

LOCK TABLES `bwjlw_users` WRITE;
/*!40000 ALTER TABLE `bwjlw_users` DISABLE KEYS */;
INSERT INTO `bwjlw_users` VALUES
(783,'root/root','root','user@ead.fr','$2y$10$p/6sN20i7lbygfAYxfbahehrzKW2YUJzQ86OyU7WK5/fbV3Hzy9lW',0,1,'2022-03-09 19:13:39','2022-03-09 19:18:12','0','',NULL,0,'','',0);
/*!40000 ALTER TABLE `bwjlw_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_viewlevels`
--

DROP TABLE IF EXISTS `bwjlw_viewlevels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `bwjlw_viewlevels`
--

LOCK TABLES `bwjlw_viewlevels` WRITE;
/*!40000 ALTER TABLE `bwjlw_viewlevels` DISABLE KEYS */;
INSERT INTO `bwjlw_viewlevels` VALUES
(1,'Public',0,'[1]'),
(2,'Enregistr├®',2,'[6,2,8]'),
(3,'Sp├®cial',3,'[6,3,8]'),
(5,'Invit├®',1,'[9]'),
(6,'Super Utilisateur',4,'[8]');
/*!40000 ALTER TABLE `bwjlw_viewlevels` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_webauthn_credentials`
--

DROP TABLE IF EXISTS `bwjlw_webauthn_credentials`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_webauthn_credentials` (
...
--
-- Dumping data for table `bwjlw_webauthn_credentials`
--

LOCK TABLES `bwjlw_webauthn_credentials` WRITE;
/*!40000 ALTER TABLE `bwjlw_webauthn_credentials` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_webauthn_credentials` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_workflow_associations`
--

DROP TABLE IF EXISTS `bwjlw_workflow_associations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_workflow_associations` (
...
--
-- Dumping data for table `bwjlw_workflow_associations`
--

LOCK TABLES `bwjlw_workflow_associations` WRITE;
/*!40000 ALTER TABLE `bwjlw_workflow_associations` DISABLE KEYS */;
/*!40000 ALTER TABLE `bwjlw_workflow_associations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_workflow_stages`
--

DROP TABLE IF EXISTS `bwjlw_workflow_stages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_workflow_stages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bwjlw_workflow_stages`
--

LOCK TABLES `bwjlw_workflow_stages` WRITE;
/*!40000 ALTER TABLE `bwjlw_workflow_stages` DISABLE KEYS */;
INSERT INTO `bwjlw_workflow_stages` VALUES
(1,57,1,1,1,'COM_WORKFLOW_BASIC_STAGE','',1,NULL,NULL);
/*!40000 ALTER TABLE `bwjlw_workflow_stages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_workflow_transitions`
--

DROP TABLE IF EXISTS `bwjlw_workflow_transitions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_workflow_transitions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Dumping data for table `bwjlw_workflow_transitions`
--

LOCK TABLES `bwjlw_workflow_transitions` WRITE;
/*!40000 ALTER TABLE `bwjlw_workflow_transitions` DISABLE KEYS */;
INSERT INTO `bwjlw_workflow_transitions` VALUES
(1,58,1,1,1,'D├®publi├®','',-1,1,'{\"publishing\":\"0\"}',NULL,NULL),
(2,59,2,1,1,'Publi├®','',-1,1,'{\"publishing\":\"1\"}',NULL,NULL),
(3,60,3,1,1,'A la corbeille','',-1,1,'{\"publishing\":\"-2\"}',NULL,NULL),
(4,61,4,1,1,'Archiv├®','',-1,1,'{\"publishing\":\"2\"}',NULL,NULL),
(5,62,5,1,1,'├ëpingl├®','',-1,1,'{\"featuring\":\"1\"}',NULL,NULL),
(6,63,6,1,1,'D├®s├®pingl├®','',-1,1,'{\"featuring\":\"0\"}',NULL,NULL),
(7,64,7,1,1,'Publi├® & ├ëpingl├®','',-1,1,'{\"publishing\":\"1\",\"featuring\":\"1\"}',NULL,NULL);
/*!40000 ALTER TABLE `bwjlw_workflow_transitions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bwjlw_workflows`
--

DROP TABLE IF EXISTS `bwjlw_workflows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bwjlw_workflows` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) DEFAULT 0,
  `published` tinyint(4) NOT NULL DEFAULT 0,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `bwjlw_workflows`
--

LOCK TABLES `bwjlw_workflows` WRITE;
/*!40000 ALTER TABLE `bwjlw_workflows` DISABLE KEYS */;
INSERT INTO `bwjlw_workflows` VALUES
(1,56,1,'COM_WORKFLOW_BASIC_WORKFLOW','','com_content.article',1,1,'2022-03-09 19:13:27',783,'2022-03-09 19:13:27',783,NULL,NULL);
/*!40000 ALTER TABLE `bwjlw_workflows` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-03-09 19:28:43